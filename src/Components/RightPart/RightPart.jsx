    ...
    <div className="py-5 sticky top-0 overflow-y-hidden">
      <div className="hideScrollbar overflow-y-scroll">
        ...
        >
          ...
          <div>
            <p className="text-sm">Tech · Trending</p>
            <p className="font-bold">#AIRevolution</p>
            <p>120K Tweets</p>
          </div>
          ...
          <div className="flex justify-between w-full">
            <div>
              ...
              <p className="font-bold">#INDvsAUS</p>
              <p>89K Tweets</p>
            </div>
            <MoreHorizIcon />
          </div>
          ...
          <div className="flex justify-between w-full">
            <div>
              <p>Education · Trending</p>
              <p className="font-bold">#FreeCourses</p>
              <p>55K Tweets</p>
            </div>
            <MoreHorizIcon />
          </div>
          ...
          <div className="flex justify-between w-full">
            <div>
              <p>Startups · Trending</p>
              <p className="font-bold">#EntrepreneurLife</p>
              <p>47K Tweets</p>
            </div>
            <MoreHorizIcon />
          </div>
